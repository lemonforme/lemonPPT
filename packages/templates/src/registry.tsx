...
import { ClosingV1, closingV1Meta, type ClosingV1Props } from './minimal/closing-v1.js';
import { ClosingV2, closingV2Meta, type ClosingV2Props } from './minimal/closing-v2.js';
import { ChartV1, chartV1Meta, type ChartV1Props } from './minimal/chart-v1.js';
import { ComparisonV1, comparisonV1Meta, type ComparisonV1Props } from './minimal/comparison-v1.js';
import { ComparisonV2, comparisonV2Meta, type ComparisonV2Props } from './minimal/comparison-v2.js';
import { ContentV1, contentV1Meta, type ContentV1Props } from './minimal/content-v1.js';
import { ContentV2, contentV2Meta, type ContentV2Props } from './minimal/content-v2.js';
import { ContentV3, contentV3Meta, type ContentV3Props } from './minimal/content-v3.js';
import { CoverV1, coverV1Meta, type CoverV1Props } from './minimal/cover-v1.js';
import { FaqV1, faqV1Meta, type FaqV1Props } from './minimal/faq-v1.js';
import { FeatureV1, featureV1Meta, type FeatureV1Props } from './minimal/feature-v1.js';
import { GalleryV1, galleryV1Meta, type GalleryV1Props } from './minimal/gallery-v1.js';
import { ImageV1, imageV1Meta, type ImageV1Props } from './minimal/image-v1.js';
import { MetricV1, metricV1Meta, type MetricV1Props } from './minimal/metric-v1.js';
import { PartnersV1, partnersV1Meta, type PartnersV1Props } from './minimal/partners-v1.js';
import { PricingV1, pricingV1Meta, type PricingV1Props } from './minimal/pricing-v1.js';
import { RoadmapV1, roadmapV1Meta, type RoadmapV1Props } from './minimal/roadmap-v1.js';
import { SplitV1, splitV1Meta, type SplitV1Props } from './minimal/split-v1.js';
import { StatsV1, statsV1Meta, type StatsV1Props } from './minimal/stats-v1.js';
import { TeamV1, teamV1Meta, type TeamV1Props } from './minimal/team-v1.js';
import { TestimonialV1, testimonialV1Meta, type TestimonialV1Props } from './minimal/testimonial-v1.js';
import { TimelineV1, timelineV1Meta, type TimelineV1Props } from './minimal/timeline-v1.js';
import { MetricV2, metricV2Meta, type MetricV2Props } from './minimal/metric-v2.js';
import { PestV1, pestV1Meta, type PestV1Props } from './minimal/pest-v1.js';
import { ProcessV1, processV1Meta, type ProcessV1Props } from './minimal/process-v1.js';
import { ProcessV2, processV2Meta, type ProcessV2Props } from './minimal/process-v2.js';
import { QuoteV1, quoteV1Meta, type QuoteV1Props } from './minimal/quote-v1.js';
import { QuoteV2, quoteV2Meta, type QuoteV2Props } from './minimal/quote-v2.js';
import { SwotV1, swotV1Meta, type SwotV1Props } from './minimal/swot-v1.js';
import { TableOfContentsV1, tableOfContentsV1Meta, type TableOfContentsV1Props } from './minimal/table-of-contents-v1.js';
