...
export interface Theme08Size_splitProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"label":"模型A","a":"20","b":"40"},{"label":"模型B","a":"25","b":"49"},{"label":"模型C","a":"30","b":"58"},{"label":"模型D","a":"35","b":"67"}];

export const theme08Size_splitMeta: LayoutMeta = buildMeta({
  id: 'theme08_size_split_v1',
  role: 'size_split',
  displayName: '区间结构',
  description: '结构页：区间结构哑铃',
  contentShape: 'size_split',
  tags: ['black-gold', 'experimental'],
});

export const theme08Size_splitSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '区间结构', subtitle: '' }),
...
export function Theme08Size_split(props: Theme08Size_splitProps): ReactNode {
