...
export interface Theme08PipelineProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }
...
export const theme08PipelineMeta: LayoutMeta = buildMeta({
  id: 'theme08_pipeline_v1',
  role: 'pipeline',
  displayName: '数据底座·管道',
  description: '数据底座页：管道式架构',
  contentShape: 'pipeline',
  tags: ['black-gold', 'experimental'],
});

export const theme08PipelineSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '数据底座·管道', subtitle: '' }),
    ...([{"key":"items","label":"节点","type":"array","itemSchema":[{"key":"name","label":"名称","type":"text"},{"key":"desc","label":"描述","type":"text"}]}] as any),
  ],
};

export function Theme08Pipeline(props: Theme08PipelineProps): ReactNode {
