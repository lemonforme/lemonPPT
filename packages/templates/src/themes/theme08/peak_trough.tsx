...
export interface Theme08Peak_troughProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"label":"模型A","a":"20","b":"40"},{"label":"模型B","a":"25","b":"49"},{"label":"模型C","a":"30","b":"58"},{"label":"模型D","a":"35","b":"67"},{"label":"模型E","a":"40","b":"76"},{"label":"模型F","a":"45","b":"85"}];

export const theme08Peak_troughMeta: LayoutMeta = buildMeta({
  id: 'theme08_peak_trough_v1',
  role: 'peak_trough',
  displayName: '峰谷·对照',
  description: '峰谷页：峰谷哑铃',
  contentShape: 'peak_trough',
  tags: ['black-gold', 'experimental'],
});

export const theme08Peak_troughSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '峰谷·对照', subtitle: '' }),
...
export function Theme08Peak_trough(props: Theme08Peak_troughProps): ReactNode {
