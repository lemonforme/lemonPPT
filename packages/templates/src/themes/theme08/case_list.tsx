...
export interface Theme08Case_listProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"title":"算力调度","num":"3","unit":"×","label":"能力层级","desc":"以黑金视觉统一表达核心能力"},{"title":"数据底座","num":"6","unit":"×","label":"能力层级","desc":"强调端到端闭环与可复用性"},{"title":"模型推理","num":"9","unit":"×","label":"能力层级","desc":"面向高端发布的实验性叙事"},{"title":"安全对齐","num":"12","unit":"×","label":"能力层级","desc":"用荧光金突出关键指标"},{"title":"生态协同","num":"15","unit":"×","label":"能力层级","desc":"以黑金视觉统一表达核心能力"},{"title":"资本闭环","num":"18","unit":"×","label":"能力层级","desc":"强调端到端闭环与可复用性"}];

export const theme08Case_listMeta: LayoutMeta = buildMeta({
  id: 'theme08_case_list_v1',
  role: 'case',
  displayName: '案例·长清单',
  description: '案例页：长清单罗列',
  contentShape: 'case',
  tags: ['black-gold', 'experimental'],
});

export const theme08Case_listSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '案例·长清单', subtitle: '' }),
...
export function Theme08Case_list(props: Theme08Case_listProps): ReactNode {
