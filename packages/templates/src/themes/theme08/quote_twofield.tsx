...
export interface Theme08Quote_twofieldProps { kicker?: string; quote?: string; fieldA?: string; cite?: string; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

export const theme08Quote_twofieldMeta: LayoutMeta = buildMeta({
  id: 'theme08_quote_twofield_v1',
  role: 'quote',
  displayName: '金句·双栏',
  description: '金句页：左右双栏对照',
  contentShape: 'quote',
  tags: ['black-gold', 'experimental'],
});

export const theme08Quote_twofieldSchema: PropsSchema = {
  fields: [
    ...footerFields(),
...
export function Theme08Quote_twofield(props: Theme08Quote_twofieldProps): ReactNode {
  const { kicker, quote = '一句话主张。', fieldA, cite, footerLeft, footerRight, _slideIdx, _editable } = props;
  
  return (
      <T08Frame className="t08-quote twofield">
        <div className="lp-theme08-sec">
          <div className="t08-quote2 twofield">
