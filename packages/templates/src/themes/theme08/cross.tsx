...
export interface Theme08CrossProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"label":"北美","value":"20"},{"label":"欧洲","value":"31"},{"label":"东亚","value":"42"},{"label":"东南亚","value":"53"},{"label":"拉美","value":"64"},{"label":"中东","value":"75"},{"label":"非洲","value":"86"}];

export const theme08CrossMeta: LayoutMeta = buildMeta({
  id: 'theme08_cross_v1',
  role: 'cross',
  displayName: '透视·交叉',
  description: '透视页：交叉条形',
  contentShape: 'cross',
  tags: ['black-gold', 'experimental'],
});

export const theme08CrossSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '透视·交叉', subtitle: '' }),
    ...([{"key":"items","label":"数据","type":"array","itemSchema":[{"key":"label","label":"标签","type":"text"},{"key":"value","label":"数值","type":"text"}]}] as any),
  ],
};

export function Theme08Cross(props: Theme08CrossProps): ReactNode {
