...
export interface Theme08Investor_mixProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"title":"战略资本","num":"3","unit":"×","label":"能力层级","desc":"以黑金视觉统一表达核心能力"},{"title":"产业资本","num":"6","unit":"×","label":"能力层级","desc":"强调端到端闭环与可复用性"},{"title":"财务资本","num":"9","unit":"×","label":"能力层级","desc":"面向高端发布的实验性叙事"}];

export const theme08Investor_mixMeta: LayoutMeta = buildMeta({
  id: 'theme08_investor_mix_v1',
  role: 'investor_mix',
  displayName: '资本来源',
  description: '资本页：投资者构成卡片',
  contentShape: 'investor_mix',
  tags: ['black-gold', 'experimental'],
});

export const theme08Investor_mixSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '资本来源', subtitle: '' }),
...
export function Theme08Investor_mix(props: Theme08Investor_mixProps): ReactNode {
