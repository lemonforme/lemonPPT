...
export interface Theme08Chapter_v3Props { chapterNo?: string; title?: string; subtitle?: string; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

export const theme08Chapter_v3Meta: LayoutMeta = buildMeta({
  id: 'theme08_chapter_v3',
  role: 'chapter',
  displayName: '章节·巨幕',
  description: '章节过渡：居中巨幕标题',
  contentShape: 'chapter',
  tags: ['black-gold', 'experimental'],
});

export const theme08Chapter_v3Schema: PropsSchema = {
  fields: [
    ...footerFields(),
...
export function Theme08Chapter_v3(props: Theme08Chapter_v3Props): ReactNode {
  const { chapterNo, title = '章节标题', subtitle, footerLeft, footerRight, _slideIdx, _editable } = props;
  
  return (
      <T08Frame className="t08-chapter big">
        <div className="lp-theme08-sec">
          <div className="t08-chapter2 big">
