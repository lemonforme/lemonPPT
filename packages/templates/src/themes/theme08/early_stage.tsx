...
export interface Theme08Early_stageProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"value":"12","unit":"亿","label":"早期轮"},{"value":"24","unit":"亿","label":"成长期"},{"value":"36","unit":"亿","label":"战略轮"},{"value":"48","unit":"亿","label":"并购"}];

export const theme08Early_stageMeta: LayoutMeta = buildMeta({
  id: 'theme08_early_stage_v1',
  role: 'early_stage',
  displayName: '早期轮',
  description: '资本页：早期轮指标墙',
  contentShape: 'early_stage',
  tags: ['black-gold', 'experimental'],
});

export const theme08Early_stageSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '早期轮', subtitle: '' }),
...
export function Theme08Early_stage(props: Theme08Early_stageProps): ReactNode {
