...
export interface Theme08Case_card_v2Props { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }
...
export const theme08Case_card_v2Meta: LayoutMeta = buildMeta({
  id: 'theme08_case_card_v2',
  role: 'case',
  displayName: '案例·大卡×2',
  description: '案例页：两列大案例卡',
  contentShape: 'case',
  tags: ['black-gold', 'experimental'],
});

export const theme08Case_card_v2Schema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '案例·大卡×2', subtitle: '' }),
...
export function Theme08Case_card_v2(props: Theme08Case_card_v2Props): ReactNode {
