...
export interface Theme08Budget_cardProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

const DEFAULT_ITEMS: any[] = [{"title":"研发","num":"3","unit":"×","label":"能力层级","desc":"以黑金视觉统一表达核心能力"},{"title":"市场","num":"6","unit":"×","label":"能力层级","desc":"强调端到端闭环与可复用性"},{"title":"生态","num":"9","unit":"×","label":"能力层级","desc":"面向高端发布的实验性叙事"}];

export const theme08Budget_cardMeta: LayoutMeta = buildMeta({
  id: 'theme08_budget_card_v1',
  role: 'budget',
  displayName: '策略卡·预算',
  description: '策略页：预算策略卡',
  contentShape: 'budget',
  tags: ['black-gold', 'experimental'],
});

export const theme08Budget_cardSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '策略卡·预算', subtitle: '' }),
...
export function Theme08Budget_card(props: Theme08Budget_cardProps): ReactNode {
