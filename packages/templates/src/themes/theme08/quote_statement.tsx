...
export interface Theme08Quote_statementProps { kicker?: string; quote?: string; fieldA?: string; cite?: string; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

export const theme08Quote_statementMeta: LayoutMeta = buildMeta({
  id: 'theme08_quote_statement_v1',
  role: 'quote',
  displayName: '金句·主张',
  description: '金句页：一句话强主张',
  contentShape: 'quote',
  tags: ['black-gold', 'experimental'],
});

export const theme08Quote_statementSchema: PropsSchema = {
  fields: [
    ...footerFields(),
...
export function Theme08Quote_statement(props: Theme08Quote_statementProps): ReactNode {
  const { kicker, quote = '一句话主张。', fieldA, cite, footerLeft, footerRight, _slideIdx, _editable } = props;
  
  return (
      <T08Frame className="t08-quote statement">
        <div className="lp-theme08-sec">
          <div className="t08-quote2 statement">
