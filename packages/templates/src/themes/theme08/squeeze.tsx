...
export interface Theme08SqueezeProps { kicker?: string; title?: string; subtitle?: string; items?: any[]; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }
...
export const theme08SqueezeMeta: LayoutMeta = buildMeta({
  id: 'theme08_squeeze_v1',
  role: 'squeeze',
  displayName: '壁垒压缩',
  description: '风险页：壁垒压缩面板',
  contentShape: 'squeeze',
  tags: ['black-gold', 'experimental'],
});

export const theme08SqueezeSchema: PropsSchema = {
  fields: [
    ...commonFields({ kicker: 'BLACK GOLD', title: '壁垒压缩', subtitle: '' }),
    ...([{"key":"items","label":"面板","type":"array","itemSchema":[{"key":"name","label":"名称","type":"text"},{"key":"note","label":"说明","type":"text"}]}] as any),
  ],
};

export function Theme08Squeeze(props: Theme08SqueezeProps): ReactNode {
