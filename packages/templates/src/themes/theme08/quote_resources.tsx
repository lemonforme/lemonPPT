...
export interface Theme08Quote_resourcesProps { kicker?: string; quote?: string; fieldA?: string; cite?: string; footerLeft?: string; footerRight?: string; _slideIdx?: number; _editable?: boolean; [key: string]: unknown; }

export const theme08Quote_resourcesMeta: LayoutMeta = buildMeta({
  id: 'theme08_quote_resources_v1',
  role: 'quote',
  displayName: '金句·资源',
  description: '金句页：资源向主张',
  contentShape: 'quote',
  tags: ['black-gold', 'experimental'],
});

export const theme08Quote_resourcesSchema: PropsSchema = {
  fields: [
    ...footerFields(),
...
export function Theme08Quote_resources(props: Theme08Quote_resourcesProps): ReactNode {
  const { kicker, quote = '一句话主张。', fieldA, cite, footerLeft, footerRight, _slideIdx, _editable } = props;
  
  return (
      <T08Frame className="t08-quote resources">
        <div className="lp-theme08-sec">
          <div className="t08-quote2 resources">
