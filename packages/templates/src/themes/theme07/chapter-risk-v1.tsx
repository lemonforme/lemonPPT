...
export interface Theme07ChapterRiskV1Props {
  number: string;
  title: string;
  subtitle?: string;
  enSubtitle?: string;
...
export const theme07ChapterRiskV1Meta: LayoutMeta = {
  id: 'theme07_chapter_risk_v1',
  theme: 'theme07',
  role: 'content',
  displayName: 'Theme 07 风险专题章节页',
  description: '深色章节页变体：风险研判专题，强调风险识别与应对框架',
  needsMedia: false,
  tags: ['chapter', 'section', 'risk', 'research'],
  contentShape: 'chapter',
};

export const theme07ChapterRiskV1Schema: PropsSchema = {
  fields: [
    { key: 'number', label: '章节号', type: 'text', inlineEditable: true, defaultValue: '04' },
    { key: 'title', label: '标题', type: 'text', inlineEditable: true, defaultValue: '风险研判' },
    { key: 'subtitle', label: '副标题', type: 'textarea', inlineEditable: true, defaultValue: '政策、估值、技术与市场四重风险扫描' },
    { key: 'enSubtitle', label: '英文副标题', type: 'textarea', inlineEditable: true, defaultValue: 'Risk Assessment / Policy · Valuation · Technology · Market' },
    {
      key: 'tags',
      label: '底部要点标签',
      type: 'array',
      minItems: 0,
      maxItems: 6,
      defaultValue: ['政策监管', '估值泡沫', '技术路线', '市场周期'],
      itemSchema: [{ key: 'item', label: '标签', type: 'text', inlineEditable: true }],
    },
    { key: 'nextHint', label: '右下角下转提示', type: 'text', inlineEditable: true, defaultValue: '→ 下页进入风险矩阵与细分项拆解' },
  ],
};

export function Theme07ChapterRiskV1(props: Theme07ChapterRiskV1Props): ReactNode {
  ...
  return (
    <div className="lp-slide lp-theme07 lp-theme07-chapter lp-theme07-chapter-risk">
      <Theme07DecoNodes />
      <Theme07WatermarkNumber number={number} />
      <div className="lp-theme07-chapter-main lp-rise">
        <Theme07IconChip name="shield" />
        <div className="lp-theme07-kicker">Risk · Chapter {number}</div>
