...
export interface Theme06QuarterQ3V1Props {
  imageUrl?: string;
  kicker?: string;
  title: string;
  subtitle?: string;
...
export const theme06QuarterQ3V1Meta: LayoutMeta = {
  id: 'theme06_quarter_q3_v1',
  theme: 'theme06',
  role: 'chart',
  displayName: 'Theme 06 Q3 季度分析',
  description: 'Q3 数据图表 + 关键事件与结论',
  needsMedia: true,
  tags: ['chart', 'quarter', 'q3', 'atlas'],
  contentShape: 'generic-chart',
};

export const theme06QuarterQ3V1Schema: PropsSchema = {
  fields: [
    { key: 'imageUrl', label: '背景图片', type: 'image' },
    { key: 'kicker', label: '顶部标签', type: 'text', inlineEditable: true, defaultValue: 'Q3 2026' },
    { key: 'title', label: '标题', type: 'text', inlineEditable: true, defaultValue: '三季度市场表现' },
    { key: 'subtitle', label: '副标题', type: 'textarea', inlineEditable: true, defaultValue: '产品迭代加速，用户规模再上台阶' },
    {
      key: 'labels',
      label: '分类标签',
      type: 'array',
    ...
    },
    {
      ...
      minItems: 1,
      maxItems: 12,
      defaultValue: [{ item: 86 }, { item: 94 }, { item: 112 }],
      itemSchema: [{ key: 'item', label: '项', type: 'number', inlineEditable: true }],
    },
    { key: 'highlight', label: '关键事件', type: 'text', inlineEditable: true, defaultValue: '9 月 2.0 版本上线，月活突破历史新高' },
    { key: 'conclusion', label: '结论', type: 'textarea', inlineEditable: true, defaultValue: 'Q3 增长质量提升，产品迭代成为主要驱动力。' },
  ],
};
...
export function Theme06QuarterQ3V1(props: Theme06QuarterQ3V1Props): ReactNode {
  ...
  return (
    <div className="lp-slide lp-theme06-quarter-q3">
