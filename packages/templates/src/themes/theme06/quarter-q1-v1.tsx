...
export interface Theme06QuarterQ1V1Props {
  imageUrl?: string;
  kicker?: string;
  title: string;
  subtitle?: string;
...
export const theme06QuarterQ1V1Meta: LayoutMeta = {
  id: 'theme06_quarter_q1_v1',
  theme: 'theme06',
  role: 'chart',
  displayName: 'Theme 06 Q1 季度分析',
  description: 'Q1 数据图表 + 关键事件与结论',
  needsMedia: true,
  tags: ['chart', 'quarter', 'q1', 'atlas'],
  contentShape: 'generic-chart',
};

export const theme06QuarterQ1V1Schema: PropsSchema = {
  fields: [
    { key: 'imageUrl', label: '背景图片', type: 'image' },
    { key: 'kicker', label: '顶部标签', type: 'text', inlineEditable: true, defaultValue: 'Q1 2026' },
    { key: 'title', label: '标题', type: 'text', inlineEditable: true, defaultValue: '一季度市场表现' },
    { key: 'subtitle', label: '副标题', type: 'textarea', inlineEditable: true, defaultValue: '年初需求回暖，核心指标实现开门红' },
    {
      key: 'labels',
      label: '分类标签',
      type: 'array',
    ...
    },
    {
      ...
      minItems: 1,
      maxItems: 12,
      defaultValue: [{ item: 42 }, { item: 58 }, { item: 73 }],
      itemSchema: [{ key: 'item', label: '项', type: 'number', inlineEditable: true }],
    },
    { key: 'highlight', label: '关键事件', type: 'text', inlineEditable: true, defaultValue: '3 月新品发布推动单月环比增长 26%' },
    { key: 'conclusion', label: '结论', type: 'textarea', inlineEditable: true, defaultValue: 'Q1 整体符合预期，三月增速加快为 Q2 奠定基础。' },
  ],
};
...
export function Theme06QuarterQ1V1(props: Theme06QuarterQ1V1Props): ReactNode {
  ...
  return (
    <div className="lp-slide lp-theme06-quarter-q1">
