...
export interface Theme06QuarterQ2V1Props {
  imageUrl?: string;
  kicker?: string;
  title: string;
  subtitle?: string;
...
export const theme06QuarterQ2V1Meta: LayoutMeta = {
  id: 'theme06_quarter_q2_v1',
  theme: 'theme06',
  role: 'chart',
  displayName: 'Theme 06 Q2 季度分析',
  description: 'Q2 数据图表 + 关键事件与结论',
  needsMedia: true,
  tags: ['chart', 'quarter', 'q2', 'atlas'],
  contentShape: 'generic-chart',
};

export const theme06QuarterQ2V1Schema: PropsSchema = {
  fields: [
    { key: 'imageUrl', label: '背景图片', type: 'image' },
    { key: 'kicker', label: '顶部标签', type: 'text', inlineEditable: true, defaultValue: 'Q2 2026' },
    { key: 'title', label: '标题', type: 'text', inlineEditable: true, defaultValue: '二季度市场表现' },
    { key: 'subtitle', label: '副标题', type: 'textarea', inlineEditable: true, defaultValue: '旺季拉动增长，渠道扩张初见成效' },
    {
      key: 'labels',
      label: '分类标签',
      type: 'array',
    ...
    },
    {
      ...
      minItems: 1,
      maxItems: 12,
      defaultValue: [{ item: 73 }, { item: 91 }, { item: 86 }],
      itemSchema: [{ key: 'item', label: '项', type: 'number', inlineEditable: true }],
    },
    { key: 'highlight', label: '关键事件', type: 'text', inlineEditable: true, defaultValue: '5 月渠道扩张覆盖 12 个新城市，带动峰值突破' },
    { key: 'conclusion', label: '结论', type: 'textarea', inlineEditable: true, defaultValue: 'Q2 峰值显著抬升，但 6 月回调提示需关注留存。' },
  ],
};
...
export function Theme06QuarterQ2V1(props: Theme06QuarterQ2V1Props): ReactNode {
  ...
  return (
    <div className="lp-slide lp-theme06-quarter-q2">
